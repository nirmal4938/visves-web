...
import "../../assets/images/gallery/galler_hero_bg1.png"
...
export const Hero = () => {
    return (
            <div className="hero-section ">
                ...
                <p className="text-white mt-4">We have added our products images as well as our other images for user refrences</p>
